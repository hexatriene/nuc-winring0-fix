...
if ($device) {
    if ($device.Status -eq 'OK') {
        ...
        Write-Host "       Device already disabled" -ForegroundColor Green
    }
} else {
...
Write-Host "  - Disabled at the device level" -ForegroundColor White
Write-Host "  - Blocked from reinstallation by Group Policy" -ForegroundColor White
